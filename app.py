...
# --- 1. AYARLAR ---
st.set_page_config(page_title="Yatırımcı Pro V12.0", layout="wide", initial_sidebar_state="expanded")

# --- 2. TASARIM VE LOGO ---
# 🔥 SENİN LOGO LİNKİN 🔥
LOGO_URL = "https://i.ibb.co/cSBqL3Bv/logo.png"

# 🔥 SENİN ARKA PLAN RENGİN (#1e1e2f) 🔥
st.markdown(
    """
    <style>
    /* Ana Arka Plan */
    ...
    /* Yan Menü (Biraz daha koyu olsun ki şık dursun) */
    ...
    div[data-testid="stMetric"] {
        ...
        border: 1px solid rgba(56, 239, 125, 0.2); /* Yeşil İnce Çerçeve */
        border-radius: 12px;
        padding: 15px;
    }
...
try:
    ...
    st.error("Google Sheet bağlantısı kurulamadı. Linki ve sayfa adlarını kontrol edin.")
    st.stop()
...
def giris_sayfasi():
    ...
    with col2:
        ...
        st.markdown(f"""
            <div class="login-box">
                <img src="{LOGO_URL}" width="160" style="margin-bottom: 15px;">
    ...
    if secim == "📊 Canlı Portföy":
        ...
        with tab2:
            if not df.empty and 'Halka Arz' in df.columns:
                ...
                else: st.info("Portföyünüzde halka arz hissesi yok.")
        ...
        if not df.empty:
            if st.button("Analizi Başlat", type="primary"):
                with st.spinner("Analiz ediliyor..."):
                    ...
                    st.info("Dağılım analizi tamamlandı.")
        else: st.warning("Veri yok.")
